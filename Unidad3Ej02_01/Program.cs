...
namespace Unidad3Ej02_01
{
    class Program
    {
        ...
        public static void AgregarEmpleado(ArrayList empleados)
        {
            string nombre;
            int sueldo;
        ...
        public static void EliminarEmpleado(ArrayList empleados)
        {
            string nombre;
        ...
        public static void  EscribirEmpleado(ArrayList empleados)
        {
