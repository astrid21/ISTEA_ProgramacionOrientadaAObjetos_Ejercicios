    ...
    public class LectorPersistidor : ILibroPersistidor<Lector>
    {
        ...
        private void SetID(Lector lector)
        {
            ...
            {             
                ...
                {
                    cmd.Connection = cnx;
                    cmd.CommandText = "lector_sel_max_id_lector";
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public Lector GetByid(int idLector)
        {
            ...
            {                
                ...
                {
                    cmd.Connection = cnx;
                    cmd.CommandText = "lector_sel_by_id";
                    cmd.CommandType = CommandType.StoredProcedure;                    
        ...
        public List<Lector> GetAll()
        {
            ...
            using (SqlConnection cnx = new SqlConnection(connectionString))
            {
                ...
                {
                    cmd.Connection = cnx;
                    cmd.CommandText = "lector_sel_all";
                    cmd.CommandType = CommandType.StoredProcedure;
